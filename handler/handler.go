...
func DownloadHandler(w http.ResponseWriter, r * http.Request) {
	...
	//attachment意思： 表示文件将会提示下载到本地，而不是直接在浏览器中打开
	w.Header().Set("Content-Descrption", "attachment;filename=\"" + fMeta.FileName + "\"")
	w.Write(data)
}

//FileMetaUpdateHandler: 重命名
